...
namespace embree
{
  ...
  //-------------------------------------------------------------------
  //
  // Nutzen :Licht Informationen in der Scene verändern
  //
  //-------------------------------------------------------------------
  void Set_Scene_Light(int Licht_Nummer, const AffineSpace3f rotate)
  {
	  //-----------------------------------
	  // TEST 
	  //-----------------------------------
	  g_device->Set_Licht(g_render_scene, Licht_Nummer, copyToArray(rotate));
	  g_device->rtCommit (g_render_scene); // -->> Hierdurch wird die Scene neu aufgebaut
